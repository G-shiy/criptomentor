...
from .views import UserRetrieveUpdate, listUserId, DestroyUser, UpdateUser, ListUser, GetAuthenticatedUser
...
urlpatterns = [
    ...
    path('GetAuthenticatedUser', GetAuthenticatedUser.as_view())
]
